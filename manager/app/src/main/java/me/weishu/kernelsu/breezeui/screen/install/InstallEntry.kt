...
import me.weishu.kernelsu.breezeui.component.dialog.DownloadDialogBreeze
...
/**
 * Breeze's install page: owns the state/action wiring so the upstream install screen
 * does not have to know about Breeze.
 */
@Composable
fun InstallEntry() {
    ...
    InstallScreenBreeze(state, actions, snackbarHost)
}
