...
internal val cottageFilled: MaterialSymbol = MaterialSymbol(
    name = "cottage",
    ...
    ImageVector.Builder(
        ...
        path(
            ...
            lineTo(10.78f, 3.92f)
            quadToRelative(0.28f, -0.2f, 0.59f, -0.3f)
            quadTo(11.68f, 3.52f, 12f, 3.52f)
            reflectiveQuadToRelative(0.64f, 0.1f)
            quadToRelative(0.31f, 0.1f, 0.59f, 0.3f)
